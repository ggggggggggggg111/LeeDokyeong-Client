...
int main(void) {
	...
	f = 1.234567891923456789123456789;
	d = 1.234567891923456789123456789;
	ld = 1.234567891923456789123456789;
	...
	// 1 3 5 7
	// 2 4 6 0
	printf("%d", arr2x_3[3][1]); // Form : 배열이름 [ 열 인덱스 ] [행 인덱스 ]
	//short arr2x_4[2][] = { 1,2,3,4 }; = error 
	// 배열은 초기화 할때 열의 크기를 정해주면 
	// 컴파일러가 배열의 크기는 알아서 확보한다.

	// 문자열 ( 문자의 배열 )
	// 문자열은 배열 마지막에 null문자가 붙는다 .
	// ===================================================================
	char str1[20] = "hello";
	char str2[6] = "hello";
	char str3[5] = "hello"; // [5] : null 문자가 들어갈 공간이 확보되지 않음
	char str4[] = "hella";
	...
	printf("% s\n", str1);
	// strlen( 문자열 값 ) : 문자열 값으 길이를 반환
	strlen(str1);
	printf("%d\n", strlen(str1));
	printf("%d\n", strlen("I don't know you"));
	// strcmp( 문자열값 1, 문자열값 2 ) : 문자열을 아스키코드로 변환했을때
	// 문자열값 1이 더 크면 양수 반환, 같으면 0 반환, 작으면 -1 반환.
	printf("%d\n", strcmp(str3, str4));
	...
	// LValue & RValue.
	// 대입연산자 기준으로 왼쪽에 있는 값을 LValue, 오른쪽에 있는 값을 RValue라고 한다
	// ===============================================================================================
